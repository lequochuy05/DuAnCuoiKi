...
import Controller.LoginAdmin_Controller;
...
public class LoginAdmin extends JFrame{
	...
	public LoginAdmin() {
		...
		ImageIcon img_tiltle = new ImageIcon("C:/Users/ASUS/Desktop/CK1/src/icon/Apps-preferences-system-login-icon.png");
		Image img = img_tiltle.getImage();
		this.setIconImage(img);
		
		Font font = new Font("Arial", Font.PLAIN,20);
		ActionListener action = new LoginAdmin_Controller(this);
